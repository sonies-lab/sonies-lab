...
- Erlenmeyers indentados de 500mL con 125 mL de LB
...
5. Incubar en shaker a 37 °C, 150 rpm hasta alcanzar un OD<sub>600 nm</sub> entre 0.5 y 0.7 (aprox. 2.5 h). 
6. Inducir con IPTG 1M. Concentracion final en cultivo 1mM de IPTG
7. Transferir a un shaker a 20 °C, 150 rpm. Incubar durante 24 h.
...
2. Lisar las células mediante ultrasonicación: 3 x 7.5 min, 30 s ON, 30 s OFF. Tomar muestra de 0.5 mL. **ADNsa y RNAsa**
...
1. Equilibrar columna HisTrap de 5 mL con 25 mL de buffer de unión. (Si es reutilizada lavar con 10mL de H2O MQ previamente)
